...
<div class="mx-auto max-w-4xl space-y-16 px-6 py-12">
	<div>
		...
		<p class="mt-2 text-muted-foreground">
			A flexible timeline component with vertical/horizontal layouts, status
			indicators, and CSS grid alignment.
		</p>
	</div>
	...
	<section class="space-y-4">
		...
		<p class="text-sm text-muted-foreground">
			Use
			<code class="rounded bg-muted px-1 py-0.5 text-xs font-mono">status</code>
	...
	<section class="space-y-4">
		...
		<p class="text-sm text-muted-foreground">
			Use
			<code class="rounded bg-muted px-1 py-0.5 text-xs font-mono">color</code>
		...
		<div class="grid grid-cols-2 gap-4">
			{#each ["start", "baseline"] as alignVal}
				<div class="rounded-lg border p-4">
					...
					<Timeline.Root size="lg" align={alignVal as "start" | "baseline"}>
						<Timeline.Item>
							<Timeline.Indicator
								>{alignVal === "start"
                                    ? "1"
