<script lang="ts">
    ...
    import TimelineItem from "$lib/registry/ui/timeline/timeline-item.svelte";
...
<div class="mx-auto max-w-4xl space-y-16 px-6 py-12">
    <div>
        ...
        <p class="mt-2 text-muted-foreground">
            A flexible timeline component with vertical/horizontal layouts,
            status indicators, and CSS grid alignment.
        </p>
    </div>
    ...
    <section class="space-y-4">
        ...
        <p class="text-sm text-muted-foreground">
            ...
            <code class="rounded bg-muted px-1 py-0.5 text-xs font-mono"
                >size="lg"</code
            >
            for numbered steps or more prominent indicators.
        </p>
        <div class="rounded-lg border p-6">
            <Timeline size="lg">
                <TimelineItem>
                ...
                <TimelineItem>
                    ...
                    <TimelineContent>
                        ...
                        <p class="text-sm text-muted-foreground">
                            Verify your data and approve the final draft for
                            accuracy.
                        </p>
                    </TimelineContent>
                </TimelineItem>
    ...
    <section class="space-y-4">
        ...
        <p class="text-sm text-muted-foreground">
            ...
            <code class="rounded bg-muted px-1 py-0.5 text-xs font-mono"
                >status</code
            >
            on timeline items to indicate progress.
        </p>
        <div class="rounded-lg border p-6">
            <Timeline horizontal>
    ...
    <section class="space-y-4">
        ...
        <p class="text-sm text-muted-foreground">
            ...
            <code class="rounded bg-muted px-1 py-0.5 text-xs font-mono"
                >color</code
            >
            on the indicator to set a colored background.
        </p>
        <div class="rounded-lg border p-6">
            <Timeline>
                <TimelineItem>
    ...
    <section class="space-y-4">
        ...
        <p class="text-sm text-muted-foreground">
            ...
            <code class="rounded bg-muted px-1 py-0.5 text-xs font-mono"
                >variant="bare"</code
            >
            to use larger standalone icons as indicators.
        </p>
        <div class="rounded-lg border p-6">
            <Timeline>
                <TimelineItem>
    ...
    <section class="space-y-4">
        ...
        <p class="text-sm text-muted-foreground">
            ...
            <code class="rounded bg-muted px-1 py-0.5 text-xs font-mono"
                >TimelineBlock</code
            >
            for full-width content blocks spanning both columns.
        </p>
        <div class="rounded-lg border p-6">
            <Timeline>
                <TimelineItem>
                ...
                <TimelineItem>
                    <TimelineBlock>
                        <div
                            class="col-span-full rounded-xl border bg-card p-4"
                        >
                                ...
                                <div class="space-y-1">
                                    <p class="text-sm font-medium">
                                        ...
                                        <span
                                            ...
                                            >replied to your message · 4 days
                                            ago</span
                                        >
                                    </p>
                                    <p class="text-sm text-muted-foreground">
    ...
    <section class="space-y-4">
        ...
        <p class="text-sm text-muted-foreground">
            Use
            <code class="rounded bg-muted px-1 py-0.5 text-xs font-mono"
                >TimelineSubgrid</code
            >
            inside a block to align avatars and content to the timeline's column
            tracks.
        </p>
        <div class="rounded-lg border p-6">
            <Timeline>
                ...
                <TimelineItem>
                    <div
                        class="col-span-full grid auto-rows-auto grid-cols-subgrid"
                    >
                        <TimelineBlock
                        ...
                        >
                            ...
                            <TimelineSubgrid class="bg-muted/30 p-3">
                                ...
                                <div class="space-y-1">
                                    ...
                                    <p class="text-sm text-muted-foreground">
                                        Contrast slider goes a bit wild at the
                                        top end...
                                    </p>
                                </div>
                            </TimelineSubgrid>
        ...
        <div class="grid grid-cols-2 gap-4">
            {#each ["start", "baseline"] as alignVal}
                <div class="rounded-lg border p-4">
                    ...
                    <Timeline
                        size="lg"
                        align={alignVal as "start" | "baseline"}
                    >
                        <TimelineItem>
                            <TimelineIndicator
                                >{alignVal === "start"
                            ...
                            <TimelineContent>
                                ...
                                <p class="text-sm text-muted-foreground">
                                    Place the indicator at the {alignVal} edge of
                                    the item row.
                                </p>
                            </TimelineContent>
                        </TimelineItem>
                        <TimelineItem>
                            ...
                            <TimelineContent>
                                ...
                                <p class="text-sm text-muted-foreground">
                                    Another item using the same indicator
                                    placement.
                                </p>
                            </TimelineContent>
                        </TimelineItem>
